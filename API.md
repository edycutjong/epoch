...
*   **Source:** [src/app/api/arm/route.ts](src/app/api/arm/route.ts)
*   **Request Body:**
...
*   **Source:** [src/app/api/heartbeat/route.ts](src/app/api/heartbeat/route.ts)
*   **Request Body:**
    *   `switchId` *(string, Required)*: Unique identifier for the switch.
...
*   **Source:** [src/app/api/status/route.ts](src/app/api/status/route.ts)
*   **Request Body:**
...
*   **Source:** [src/app/api/check-trigger/route.ts](src/app/api/check-trigger/route.ts)
*   **Request Body:**
...
*   **Source:** [src/app/api/fire-epoch/route.ts](src/app/api/fire-epoch/route.ts)
*   **Request Body:**
    *   `switchId` *(string, Required)*: Unique identifier.
...
*   **Source:** [src/app/api/cancel/route.ts](src/app/api/cancel/route.ts)
*   **Request Body:**
...
*   **Source:** [src/app/api/verify-vc/route.ts](src/app/api/verify-vc/route.ts)
*   **Request Body:**
...
*   **Source:** [src/app/api/notifications/route.ts](src/app/api/notifications/route.ts)
*   **Response:**
...
*   **Source:** [src/app/api/integrations/verify/route.ts](src/app/api/integrations/verify/route.ts)
*   **Response:**
...
*   **Source:** [src/app/api/seed/legacy/route.ts](src/app/api/seed/legacy/route.ts)
*   **Request Body:**
...
*   **Source:** [src/app/api/seed/profile/route.ts](src/app/api/seed/profile/route.ts)
*   **Request Body:**
